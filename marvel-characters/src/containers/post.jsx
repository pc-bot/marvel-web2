    ...
    return(
        <div className="flex items-center justify-center fixed inset-0  bg-opacity-30">
            ...
            <form className="m-5">
                ...
                <input type="text" name="name" className="bg-gray-100 border border-gray-300 p-2 rounded" required />
                <br />
                </div>
                <div className="flex flex-col mt-3">
                <label className="text-blue-900">Real Name:</label>           
                <input type="text" name="realName" className="bg-gray-100 border border-gray-300 p-2 rounded" required />
                <br />
                </div>
                <div className="flex flex-col mt-3">
                <label className="text-blue-900">Universe:</label>        
                <input type="text" name="universe" className="" required />
                <br />
                </div>
